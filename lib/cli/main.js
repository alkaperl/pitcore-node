...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `pitcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ pitcore-node add wallet-service');
      console.log('    $ pitcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ pitcore-node remove wallet-service');
      console.log('    $ pitcore-node remove insight-api');
      console.log();
    });
