...
/**
 * Will return the path and pitcore-node configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'pitcore-node.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'pitcore-node.json'))
  };
}
