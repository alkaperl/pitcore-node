...
/**
 * Will return the path and default pitcore-node configuration. It will search for the
 * configuration file in the "~/.pitcoin" directory, and if it doesn't exist, it will create one
...
function getDefaultConfig(options) {
  ...
  var defaultPath = path.resolve(process.env.HOME, './.pitcoin');
  var defaultConfigFile = path.resolve(defaultPath, './pitcore-node.json');
